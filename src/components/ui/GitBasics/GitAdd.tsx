...
// ******************************************************************************************************      */}
    ...
    {/* Nếu css luôn đặt tên lớp ngoài cùng = tên task. Ví dụ className = "GitAdd" 
    CSS luôn bắt đầu: 
        TenTask<GitAdd> + CSS-Selector {
        // nội dung css ở đây    
    }
    */}
      <div className="flex-1 p-6">
        
        <h1 className="text-3xl font-bold">Hiện thực trang Git Add tại Đây</h1>
        <p className="mt-4">
